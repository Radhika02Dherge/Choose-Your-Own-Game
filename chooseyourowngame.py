...
if answer == "left":
    ...
    answer = input("You come to a bridge, it looks wobbly, do you want to cross it or head back(crooss/back)?  ")
    ...
    if answer == "back":
        ...
        if answer == "yes":
            print("You talk to a stranger and they give you a gold.You WIN!!! Congrats")
        elif answer == "no":
